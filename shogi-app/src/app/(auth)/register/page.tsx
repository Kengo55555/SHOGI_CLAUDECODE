    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="card-yukaku rounded-xl p-8 max-w-md w-full text-center">
          ...
          <h1 className="font-[family-name:var(--font-noto-serif)] text-2xl font-bold text-kinpaku mb-4">御登録</h1>
          <p className="text-[#F4E4C1]/60 mb-6 text-sm"><span className="text-[#D4A017] font-medium">{email}</span> で登録いたします</p>
          <a href={verifyUrl} className="btn-kurenai inline-block w-full py-3 rounded-lg text-lg tracking-[0.3em]">参 入</a>
          <p className="text-xs text-[#D4A017]/30 mt-4 font-serif">十五分以内にお済ませください</p>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="card-yukaku rounded-xl p-8 max-w-md w-full shadow-lg shadow-black/20">
        <div className="divider-hana w-24 mx-auto mb-6" />
        <h1 className="font-[family-name:var(--font-noto-serif)] text-3xl font-bold text-center mb-2 text-kinpaku tracking-wider">将棋処</h1>
        <p className="text-center text-[#D4A017]/50 mb-6 text-sm font-serif">御新規の方はこちらから</p>
        ...
        <p className="text-center text-xs text-[#F4E4C1]/30 mt-4 font-serif">お馴染みの方もこちらからお入りいただけます</p>
        <div className="text-center mt-3">
          <Link href="/" className="text-xs text-[#D4A017]/40 hover:text-[#D4A017] transition-colors font-serif">表へ戻る</Link>
        </div>
        <div className="divider-hana w-24 mx-auto mt-6" />
      </div>
    </div>
